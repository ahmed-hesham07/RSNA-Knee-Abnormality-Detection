...
cells = [
    ...
    },
    {
        ...
        'source': [
            ...
            '\n',
            '# Silence HuggingFace and general warnings\n',
            ...
            '    n_folds = 5\n',
            '    folds_to_train = [0, 1, 2, 3, 4]  # Change to [1], [2], etc. or leave [0, 1, 2, 3, 4] for full CV loop\n',
            '    epochs = 6\n',
            '    batch_size = 8\n',
            '    lr = 2e-4\n',
            '    min_lr = 1e-6\n',
    ...
    },
    {
        ...
        'source': [
            ...
            'print(f"Folds scheduled for training: {CFG.folds_to_train}")\n',
            '\n',
            'oof_scores = {}\n',
            '\n',
            'for fold_idx in CFG.folds_to_train:\n',
            '    print(f"\\n==================================================")\n',
            '    print(f"========== STARTING FOLD {fold_idx} TRAINING ==========")\n',
            '    print(f"==================================================")\n',
            '    \n',
            '    train_split = train_df[train_df["fold"] != fold_idx].reset_index(drop=True)\n',
            '    val_split = train_df[train_df["fold"] == fold_idx].reset_index(drop=True)\n',
            '    print(f"Fold {fold_idx}: {len(train_split)} Train Studies | {len(val_split)} Val Studies")\n',
            '    \n',
            ...
            '        if pt_files:\n',
            '            chosen_pt = pt_files[fold_idx % len(pt_files)]\n',
            ...
            '    \n',
            '    best_auc = 0.0\n',
            '    save_name = f"multiview_dinov2_fold{fold_idx}_best.pth"\n',
            '    \n',
            ...
            '        \n',
            '        print(f"Fold {fold_idx} Epoch {epoch+1} | Train Loss: {t_loss:.4f} | Val Loss: {v_loss:.4f} | Val Macro AUC: {v_auc:.4f}")\n',
            '        \n',
            '        if v_auc > best_auc:\n',
            '            best_auc = v_auc\n',
            ...
            '    \n',
            '    oof_scores[fold_idx] = best_auc\n',
            '    print(f"\\n>>> Fold {fold_idx} Finished! Best Val Macro AUC: {best_auc:.4f}")\n',
            '    \n',
            '    # Free GPU VRAM for the next fold\n',
            '    del model, train_loader, val_loader, optimizer, scheduler, scaler\n',
            '    torch.cuda.empty_cache()\n',
            '    gc.collect()\n',
            '\n',
            'print(f"\\n==================================================")\n',
            'print(f"All requested folds complete! Summary:")\n',
            'for f_id, score in oof_scores.items():\n',
            '    print(f"  Fold {f_id}: Best Val Macro AUC = {score:.4f}")\n',
            'print(f"Mean OOF Macro AUC: {np.mean(list(oof_scores.values())):.4f}")\n',
            'print(f"==================================================")\n'
        ]
    }
]
...
with open('notebooks/RSNA_Knee_MultiView_DINOv2_Training.ipynb', 'w') as f:
    json.dump(notebook, f, indent=2)

print("RSNA_Knee_MultiView_DINOv2_Training.ipynb created successfully!")
